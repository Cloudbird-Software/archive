...
3. ADR 正本字节保真（verify_migration.py 强制）；ADR 状态与索引唯一真源 = 本仓 `adr/INDEX.yaml`（ADR-0085 家园单仓化）；新 ADR 落位流程见 [README.md](README.md) 引 ADR-0053 决策 3
...
| 找某条 ADR | [adr/](adr/)（lifecycle/decision_status 查同目录 `INDEX.yaml`，ADR-0085 家园单仓化） |
